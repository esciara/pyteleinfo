...
latex_documents = [
  ("index", "teleinfo.tex", u"teleinfo Documentation", authors, "manual"),
]
...
man_pages = [
    ("index", "teleinfo", u"teleinfo Documentation", [authors], 1)
]
...
texinfo_documents = [
  ("index", "teleinfo", u"teleinfo Documentation", authors,
   "teleinfo", "A serial reader for ENEDIS teleinfo.", "Miscellaneous"),
]
