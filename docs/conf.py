...
extlinks = {
    ...
    "issue": ("https://github.com/esciara/pyteleinfo/issue/%s", "issue #"),
    "youtube": ("https://www.youtube.com/watch?v=%s", "youtube:video="),
    "teleinfo": ("https://github.com/esciara/pyteleinfo", None),
}
...
# -----------------------------------------------------------------------------
project = "pyteleinfo"
authors = "Emmmanuel Sciara"
copyright = "2019, %s" % authors
...
if html_theme == "bootstrap":
    ...
    html_theme_options = {"navbar_site_name": "Document", "navbar_pagenav": True}
    ...
    html_logo = "_static/teleinfo_logo1.png"
...
htmlhelp_basename = "teleinfo.doc"
...
man_pages = [("index", "teleinfo", "teleinfo Documentation", [authors], 1)]
...
texinfo_documents = [
    (
        "index",
        "teleinfo",
        "teleinfo Documentation",
        authors,
        "teleinfo",
        "A serial reader for ENEDIS teleinfo.",
        "Miscellaneous",
    )
]
...
pdf_documents = [("index", project, project, authors)]
